...
set(VTK_MODULES_DIR "/Users/biyeuphuong/Desktop/CIS541/build/lib/cmake/vtk-8.2/Modules")
...
set(VTK_CMAKE_DIR "/Users/biyeuphuong/Desktop/CIS541/VTK-8.2.0/CMake")
...
if (__vtk_install_tree)
  ...
  if (WIN32)
    set (VTK_RUNTIME_DIRS "/Users/biyeuphuong/Desktop/CIS541/build/bin")
  else ()
    set (VTK_RUNTIME_DIRS "/Users/biyeuphuong/Desktop/CIS541/build/lib")
  endif ()
endif()
...
# Import VTK targets.
set(VTK_CONFIG_TARGETS_FILE "/Users/biyeuphuong/Desktop/CIS541/build/VTKTargets.cmake")
if(NOT TARGET vtkCommonCore)
  include("${VTK_CONFIG_TARGETS_FILE}")
endif()

# Load module interface macros.
include("/Users/biyeuphuong/Desktop/CIS541/VTK-8.2.0/CMake/vtkModuleAPI.cmake")
